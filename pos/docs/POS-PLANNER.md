...
**說明**：
- `options.spicy`：辣度選擇（Phase 2 新增）
- `options.custom`：客製化備註（Phase 2 擴充）
...
**狀態**：Phase 1 原型基本完成（含規格選擇、手動折扣、每日結帳條、歷史查詢、結帳優化、訂單編號優化、匯出功能優化），列印整合待開發
